...
class QuestionAskedNotification extends MyNotification
{
    use Queueable;
    ...
    {
        return (new MailMessage)->markdown('mail.question-asked-' . $this->partner->partner_id, [
            'submission' => $this->submission
        ])
            ->subject(__("case-submit.case_question"))
