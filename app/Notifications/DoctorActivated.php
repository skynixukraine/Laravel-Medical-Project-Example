...
class DoctorActivated extends QueueableNotification
{
    ...
    public function toMail($notifiable)
    {
        return $this->createMailMessage()
            ...
            ->line(__('Please complete the information in your account: :account, in particular the billing details :billing and request approval from the administrator. You will enter the bank details with our payment provider Stripe, who will handle the automatic payment - so you will receive your remuneration automatically transferred to the bank account almost in real time. We cannot therefore activate this data before it is stored.',
                ['account' => config('app.url') . '/account/personal-information', 'billing' => config('app.url') . '/account/billing']))
