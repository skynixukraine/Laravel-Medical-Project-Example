...
class SubmissionAnsweredNotification extends MyNotification
{
    use Queueable;
    ...
    {
        return (new MailMessage)->markdown('mail.submission-answered-' . $this->partner->partner_id, [
            'submission' => $this->submission
        ])
            ->subject(__("case-submit.case_answered"))
