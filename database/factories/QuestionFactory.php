...
$factory->state(App\Models\Question::class, 'open', function (Faker $faker) {

    $submission_id = rand(1,10);
    $submission = \App\Models\Submission::find($submission_id);
...
$factory->state(App\Models\Question::class, 'answered', function (Faker $faker) {
