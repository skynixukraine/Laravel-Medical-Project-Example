...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">sna</a>
        </div>
    </div>
</nav>
...
<div class="jumbotron" style="background-color: white">
    <div class="container">
        <h2>online-dermatologist.net</h2>
        <p>Please enter your case number here:</p>
        <iframe id="iframeCaseSearch" src="{{ config('app.MIX_API_URL') }}/case-search-sna" style="width: 100%; border: none; margin: 0;"></iframe>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <iframe id="iframeCaseSubmit" src="{{ config('app.MIX_API_URL') }}/case-submit-sna" style="width: 100%; border: none; margin: 0;"></iframe>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <h2>You have got skin problems?</h2>
            <p>With Snapdoc you receive a specialist assessment of your skin problem quickly, location-independent and cost-effectively (35.- Euro). Thanks to the recommended action, you also know what you can do about it.</p>
            <p>Now contact one of our German, english speaking, specialists for skin diseases.</p>
        </div>
        <div class="col-md-4">
            <h2>Heading</h2>
