...
<body id="case-submit" class="partner-ita">
<!-- --------------- -->
<!-- submission_form -->
<!-- --------------- -->
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form id="submission_form" class="form-horizontal">
                ...
                <input type="hidden" name="partner_id" id="submission_partner_id" value="ita">
                <h2>1. Laden Sie Fotos der betroffenen Region hoch</h2>
                <p class="col-sm-12" style="font-style: italic">Durch das Hochladen eines Bildes erklären Sie sich mit unserer <a href="{{ config('app.ita.MIX_WEB_URL') }}/datenschutz" target="_blank">Datenschutzerklärung</a> einverstanden.</p>
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p id="submission_note_symptoms">Welche Beschwerde(n) verursacht Ihr intimes Problem?<br>
                            Wählen Sie alle Punkte aus, die auf Ihr intimes Problem zutreffen.
                        </p>
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p>Tritt das Problem einseitig oder beidseitig auf?<br>
                            (Nur an der rechten Seite Ihres Intimbereichs, z.B. nur der rechten Schamlippe oder dem rechten Teil des Hodens, würde z.B. einseitig bedeuten.)
                        </p>
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p>Wo genau tritt Ihr intimes Problem auf? An welcher Stelle Ihres Körpers ist das Problem zu sehen?</p>
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p>Wie lange leiden Sie bereits an Ihrem intimen Problem?</p>
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p>Haben Sie bereits ein Medikament oder eine Salbe benutzt, um Ihr intimes Problem zu lindern?</p>
                        <label class="radio-inline">
                ...
                <div class="form-group form-group-beschreibung">
                    ...
                    <div class="col-sm-9">
                        <p>Haben Sie weitere Informationen, die für die Bearbeitung Ihres Anliegens wichtig sind?
                            Eine genaue Beschreibung hilft uns, Sie möglichst individuell zu beraten.</p>
                    ...
                    <div class="col-sm-offset-3 col-sm-9">
                        <div class="checkbox">
                            <label>
                                ...
                                <a href="{{ config('app.ita.MIX_WEB_URL') }}/agb" target="_blank">allgemeinen Geschäftsbedingungen</a> und die
                                <a href="{{ config('app.ita.MIX_WEB_URL') }}/datenschutz" target="_blank">Datenschutzerklärung</a>.
                            </label>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="alert alert-info">
                ...
                <p>Sollte der Bezahlvorgang fehlschlagen, können Sie diesen auch zu einem späteren Zeitpunkt erneut ausführen, indem Sie ihre Fallnummer hier eintragen:
                    <a href="https://intimarzt.de/fall-ansehen/" target="_blank" style="font-weight: bold">Fall ansehen</a></p>
            </div>
        </div>
    </div>
</div>
