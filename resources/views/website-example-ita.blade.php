...
<div class="jumbotron" style="background-color: white">
    <div class="container">
        ...
        <iframe id="iframeCaseSearch" src="{{ config('app.MIX_API_URL') }}/case-search-ita" style="width: 100%; border: none; margin: 0;"></iframe>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <iframe id="iframeCaseSubmit" src="{{ config('app.MIX_API_URL') }}/case-submit-ita" style="width: 100%; border: none; margin: 0;"></iframe>
        </div>
    </div>
</div>
